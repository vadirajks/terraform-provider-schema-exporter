resource "azurerm_sentinel_alert_rule_scheduled" "name" {
  ...
  query_frequency = string (Optional)
  query_period = string (Optional)
  ...
  trigger_operator = string (Optional)
  trigger_threshold = number (Optional)
  ...
  event_grouping block "list" (Optional) {
