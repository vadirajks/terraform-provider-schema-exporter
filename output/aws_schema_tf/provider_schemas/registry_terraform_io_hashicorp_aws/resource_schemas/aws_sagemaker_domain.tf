resource "aws_sagemaker_domain" "name" {
  ...
  default_space_settings block "list" (Optional) {
  ...
  default_user_settings block "list" (Required) {
    execution_role = string (Required)
