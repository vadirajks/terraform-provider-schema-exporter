...
├── extract\_schema\_json.py  \#  
├── extract\_schema\_tf.py    \# \<-- Core Python scripts  
├── extract\_schema\_yaml.py  \#  
├── main.tf                 \# \<-- Your provider definitions  
├── output/                 \# \<-- All generated files land here  
│   ├── aws\_schema\_json/  
│   ├── aws\_schema\_tf/  
│   ├── aws\_schema\_yaml/  
│   ├── azurerm\_schema\_json/  
│   ├── ...  
├── README.md  
├── schema.json             \# \<-- Generated by 'all.sh'  
├── split\_schema\_json.sh    \#  
├── split\_schema\_tf.sh      \# \<-- Helper scripts  
└── split\_schema\_yaml.sh    \#
...
├── aws\_schema\_tf  
│   └── provider\_schemas  
│       └── registry\_terraform\_io\_hashicorp\_aws  
│           ├── data\_source\_schemas  
│           │   ├── aws\_instance.tf  
│           │   └── ...  
│           ├── provider  
│           │   └── aws.tf  
│           ├── resource\_identity\_schemas  
│           │   ├── aws\_iam\_role.tf  
│           │   └── ...  
│           └── resource\_schemas  
│               ├── aws\_instance.tf  
...
resource "aws\_instance" "name" {  
  ...
  // Optional arguments  
  associate\_public\_ip\_address \= bool (Optional)  
  availability\_zone \= string (Optional, Computed)  
  cpu\_core\_count \= number (Optional, Computed)  
  // ...

  capacity\_reservation\_specification block "list" (Optional) {  
    // Optional arguments  
    capacity\_reservation\_preference \= string (Optional)

    capacity\_reservation\_target block "list" (Optional) {  
      // Optional arguments  
      capacity\_reservation\_id \= string (Optional)  
      capacity\_reservation\_resource\_group\_arn \= string (Optional)  
    }  
  }

  ebs\_block\_device block "set" (Optional, Computed) {  
    // Required arguments  
  ...
  arn \= string (Computed)  
  id \= string (Computed)  
  primary\_network\_interface\_id \= string (Computed)  
  // ...  
}  
